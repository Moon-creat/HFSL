...
dataset_train = SkinData(train, transform = transform_train)
dataset_test = SkinData(test, transform = transform_test)


# ----------------------------------------------------------------
dataset_train = torchvision.datasets.CIFAR10(root='./data/cifar-10', train=True, download=True,
                                             transform=transform_train)
dataset_test = torchvision.datasets.CIFAR10(root='./data/cifar-10', train=False, download=True,
...
for iter in range(epochs):
    ...
    for local_dict in w_locals_client:
        for key, val in local_dict.items():
            if key in net_dict:
                net_dict[key] = net_dict[key] + val
                net_dict_cnt[key] = net_dict_cnt[key] + 1
            else:
                net_dict[key] = val
                net_dict_cnt[key] = 1

    for key, val in net_dict.items():
        net_dict[key] = net_dict[key] / net_dict_cnt[key]

        # Ater serving all clients for its local epochs------------
        # Fed  Server: Federation process at Client-Side-----------
    print("-----------------------------------------------------------")
    print("------ FedServer: Federation process at Client-Side ------- ")
    net_glob_client.load_state_dict(copy.deepcopy(net_dict))
...
file_name = "2-SFLV2-cifar10" + ".xlsx"
