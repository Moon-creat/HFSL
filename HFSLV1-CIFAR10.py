# ============================================================================
# HFSLV1 learning: ResNet18 on CIFAR10
# ============================================================================
import torch
...
def train_server(fx_client, y, l_epoch_count, l_epoch, idx, len_batch, middle_output1, middle1_fea, alpha, beta,
    ...
    # ---------forward prop-------------
    fx_server, final_fea, middle_output, middle_fea = net_server(fx_client)
...
def evaluate_server(fx_client, y, idx, len_batch, ell):
    ...
    with torch.no_grad():
        ...
        y = y.to(device)
        # ---------forward prop-------------
        fx_server, final_fee, a, b = net(fx_client)
...
dataset_train = torchvision.datasets.CIFAR10(root='./data/cifar-10', train=True, download=True, transform=transform_train)
dataset_test = torchvision.datasets.CIFAR10(root='./data/cifar-10', train=False, download=True, transform=transform_test)
...
for iter in range(epochs):
    ...
    for idx in idxs_users:
        net_dict = copy.deepcopy(net_glob_client.state_dict())
        local = None
        if (idx % 3 == 0):
        ...
        for key, val in w_client.items():
            net_dict[key] = val
        w_locals_client.append(net_dict)
